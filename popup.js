...
function computeWorkedFromPairsClamped(pairs, nowMin) {
  ...
  for (const p of (pairs || [])) {
    ...
    // OUT-only pair (leading OUT) → treat as started at office start
    if (inMin == null && outMin != null) inMin = START;
